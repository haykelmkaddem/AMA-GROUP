...
@media only screen and (max-width: 400px) {
    .content, .events-container, .year-header, .calendar-container, .events-container-date {
        width: 320px;
    }
    .dialog {
        width: 320px;
...
<body>
  <div class="content">
    ...
    <div class="events-container-date">
    	<h3 class="jour"></h3>
    	<h1 class="date-complet"></h1>
    	<h1 class="date-chiffre" hidden></h1>
 
    </div>
    <div class="events-container" id="style-2">
...
<div id="language-dropdown" tabindex="0">
        ...
        <form class="form" id="form" action="ajouter_ren.php" method="post">
        	<input type="hidden" name="azert" class="date-chiffre1" >
          	<table align="center" style="width: 380px; padding-top: 10px;">
          		<tr>
